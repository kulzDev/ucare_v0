        ...
        <div class="bg-white tm-block">
            ...
            <div class="row mt-4 tm-edit-product-row justify-content-center">
                <div class="col-xl-7 col-lg-7 col-md-12">                 
                    ...
                    {!! Form::open(['action'=>'admin\VoucherController@store', 'class' => 'tm-edit-product-form']) !!}             

                        <div class="input-group mb-3">
                                {!! Form::label('name', 'Voucher Name: ', ['class' => 'col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label']) !!}                              
                                {!! Form::text('Name', $value = null, ['class' => 'form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7', 'placeholder' => 'Voucher Name']) !!}                                
                        </div>                 
                        
                        <div class="input-group mb-3">
                                {!! Form::label('Description', 'Voucher Description : ', ['class' => 'col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label']) !!}                              
